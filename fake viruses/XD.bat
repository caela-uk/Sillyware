...
echo \ [######----]
echo /
echo \ Alerting authorities of your location
echo /
echo \
echo /
echo \
...
echo \ [##########]
echo /
echo \ [CALL ANSWERED] - Results pending / [DATA UPLOADED] - uploaded 489 total passwords to webuyanydata.co.ck
echo /
echo \
echo /
echo \
